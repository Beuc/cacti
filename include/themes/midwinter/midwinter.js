...
function get_displayOptions_content() {
    ...
    filters_content =
        ...
        +       '<label class="tab-label" for="tab-columns">Columns <i class="fa fa-chevron-down"></i></label>'
...
function get_dashboards_content(){
        ...
        if (cactiConsoleAllowed) {
            compact_tab_menu_content +=
                ...
                +        '<i class="menu_glyph ignore ti ti-home"></i>'
                +        '<span>'+cactiHome+'</span>'
                +    '</a>'
                +    '<ul>'
...
function get_help_content() {
    let compact_help_menu_content =
        ...
        +       '<a class="menu_parent" href="#" inert>'
        +           '<i class="menu_glyph ti ti-cloud-data-connection"></i>'
        ...
        +       '<a class="menu_parent" href="#" inert>'
        +           '<i class="menu_glyph fa fa-bug"></i>'
...
function get_user_content() {
    ...
    let compact_user_menu_content =
        ...
        +       '<a class="menu_parent" href="#" inert>'
        +           '<i class="menu_glyph far fa-user-edit""></i>'
        ...
        +       '<a class="menu_parent" href="#" inert>'
        +           '<i class="menu_glyph ti ti-palette"></i>'
        ...
        +   '<li class="menuitem double" id="menu_user_action">'
        +       '<a class="menu_parent" href="#" inert>'
        +           '<i class="menu_glyph ti ti-device-tablet"></i>'
